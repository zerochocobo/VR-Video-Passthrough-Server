...
These documents are static enough to keep in code: the device description lets
clients discover ContentDirectory and ConnectionManager, while the SCPD bodies
describe the small SOAP action surface implemented by this server.
"""
from __future__ import annotations

from config import DEVICE_UUID, MANUFACTURER, MODEL_NAME, SERVER_NAME
...
# ContentDirectory SCPD: Browse and the required capability/update actions.
def cds_scpd() -> str:
