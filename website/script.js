...
const translations = {
  en: {
    ...
    "featureCards.performance.icon": "RTX",
    "featureCards.performance.title": "HD Super Resolution",
    "featureCards.performance.text": "Use NVIDIA RTX Video Super Resolution to upscale 2D video from 1080p to 4K in realtime, or VR video from 4K to 8K.",
  ...
  zh: {
    ...
    "featureCards.performance.icon": "RTX",
    "featureCards.performance.title": "高清超分辨率",
    "featureCards.performance.text": "使用NVIDIA RTX Video Super Resolution，可实时将2D视频从1080p转换为4K，或将VR视频从4K转换为8K。",
  ...
  ja: {
    ...
    "featureCards.performance.icon": "RTX",
    "featureCards.performance.title": "高画質超解像",
    "featureCards.performance.text": "NVIDIA RTX Video Super Resolutionを使用し、2D動画を1080pから4Kへリアルタイム変換、またはVR動画を4Kから8Kへ変換できます。",
