...
const translations = {
  en: {
    ...
    "featureCards.performance.title": "Optimized for high-resolution sources",
    "featureCards.performance.text": "The pipeline is tuned around VRAM and throughput, targeting 8K-class VR180 sources when hardware can sustain them.",
  ...
  zh: {
    ...
    "featureCards.performance.title": "面向高分辨率素材优化",
    "featureCards.performance.text": "围绕 VRAM 和吞吐做了大量调优，硬件足够时可处理 8K 级 VR180 素材。",
  ...
  ja: {
    ...
    "featureCards.performance.title": "高解像度ソース向けに最適化",
    "featureCards.performance.text": "VRAM とスループットを意識して調整されており、ハードウェアが対応できる場合は 8K クラスの VR180 ソースを目指します。",
    "gallery.eyebrow": "出力例",
